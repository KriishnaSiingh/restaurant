...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, hsl(var(--cinematic-card-start)) 0%, hsl(var(--cinematic-card-end)) 100%);
      box-shadow: 
...
export function CinematicHero({ 
  brandName = "Sagar Shree",
  tagline1 = "Savor the flavors,",
  tagline2 = "wherever you are.",
  cardHeading = "Authentic delivery.",
  cardDescription = <><span className="text-white font-semibold">Our Kitchen</span> empowers your dining experience by delivering our signature dishes piping hot directly to your doorstep with incredible tracking and speed.</>,
  metricValue = 15,
  metricLabel = "Mins Prep Time",
  ctaHeading = "Order Now.",
  ctaDescription = "Craving our specialties? Get them delivered lightning fast via Zomato or Swiggy.",
  className, 
  ...props 
}: CinematicHeroProps) {
    ...
    const ctx = gsap.context(() => {
      ...
      const scrollTl = gsap.timeline({
        scrollTrigger: {
          ...
          start: "top top",
          end: "+=5000", // Adjusted from 7000 to 5000 for slightly faster progression
          pin: true,
          scrub: 1,
          anticipatePin: 1,
          refreshPriority: 10,
          ...
          onEnterBack: () => {
            gsap.set(mainCardRef.current, { autoAlpha: 1 });
          }
        },
      });
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-full h-[100vh] overflow-hidden flex items-center justify-center bg-background font-sans antialiased", className)}
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-full px-4 will-change-transform transform-style-3d">
        <h2 className="text-track gsap-reveal text-3d-matte text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-2">
          {tagline1}
        </h2>
        <h2 className="text-days gsap-reveal text-silver-matte text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter">
          {tagline2}
        </h2>
      </div>

      {/* BACKGROUND LAYER 2: Tactile CTA Buttons */}
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-full px-4 gsap-reveal will-change-transform">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <a href={siteData.swiggyLink} target="_blank" rel="noreferrer" aria-label="Order on Swiggy" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-background">
            ...
            <div className="text-left">
              ...
              <div className="text-xl font-bold leading-none tracking-tight text-orange-500">Swiggy</div>
            </div>
          </a>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-6xl md:text-7xl lg:text-[7rem] font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0 text-center lg:text-right leading-none">
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Delivery</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">SS</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-500/20 to-red-600/5 flex items-center justify-center mr-3 border border-red-400/20 shadow-inner">
                            <svg className="w-4 h-4 text-red-400 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Piping Hot</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Fresh out the oven</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Lightning Fast</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Express delivery</p>
                  </div>
                </div>
